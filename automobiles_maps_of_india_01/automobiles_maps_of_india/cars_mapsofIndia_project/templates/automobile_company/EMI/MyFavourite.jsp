...
<script>
  ...
  gtag('config', 'G-6S2WJM8ZKC');
     ...
     <title> List of Favourite Models </title>
    ...
    <script>
           function getbutton(x)
                        ...
                        document.frm.action="deleteFavourite.jsp";
                         document.frm.delbutton.value=x;
                        }
                        else
                        {
                        document.frm.action="MyFavourite.jsp";
 ...
 <%@include  file="header.jsp" %>            
        ...
        <table cellspacing="5" cellpadding="0" border="0" width="98%" align="center" style="border:0px;">
            <tr>
                ...
                <tr>
                    <td class="featured" colspan="2">Favorited Models</td>
                ...
                cntquery="select count(*) as counts   from jobs,category,favourite  where  jobs.category=category.Category_id and  jobs.job_id=favourite.job_id and favourite.User_id='"+userid+"'";
                ...
                <tr>
                    <td class="featured" colspan="5">No Models has  been added as favorite.</td>
                ...
                int counter=0;
                String query="select jobs.* ,category.Category_name  from  jobs,category,favourite  where  jobs.category=category.Category_id and  jobs.job_id=favourite.job_id and favourite.User_id='"+userid+"'  order by jobs.job_id desc limit  "+startfrom+" , 12";
