           ...
           var len=category.length;
            if(len==0)
                    ...
                    for(i=0;i<len;i++)
                        ...
                        {
                        alert("Please remove special characters from Brand");
                        document.getElementById("category").focus();
                        bool=1;
                        return false;
                        }  
                ...
                <td>                           
                    ...
                    <tr> 
                        <td  class="inner-heading">     
                            ...
                            <span class="featured">Add Company </span> 
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="upload-mid" align="left"> 
                            ...
                            <form action="delCategory.jsp" method="post" name="frm1">
                                <span class="create-category">&nbsp;&nbsp;Companies </span>
                                <span class="text4">
                            ...
                            <div style="padding-left:60" align="left"> 
                                ...
                                <form action="insertUserCategory.jsp" method="post" name="frm2">
                                    ...
                                    <br>Enter New Company :&nbsp;&nbsp;&nbsp; 
                                    <input type="text" name="category" id="category"><br><br>
                                    
                                    <script type="text/javascript">
                                                    <!--
                                                    document.write(' <input type="button" value="Add Company" name="in" id="in"  onclick= "return checkEx()" >');
                                                    -->
                                    </script>
