                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="100%" >
                                    <tr> 
                                        <td  class="inner-heading">     
                                            ...
                                            <span class="featured">Login </span> 
                                        </td>
                                    </tr>
                                    
                                    <tr>
                                        <td  align="center"> <form name="user_login"  method="post" action="login_check.jsp">                    
                                                <br><table border="0" cellspacing="0" cellpadding="10"    width="97%" class="upload-mid" >                        
                                                    ...
                                                    <tr>                            
                                                        ...
                                                        <td>&nbsp;<input type="hidden"  name="favourite">    
                                            ...
                                            -->
                                                    ...
                                                    <tr>                            
                                                        <td colspan="3" align="center">                                 
                                                            ...
                                                            <span class="text4"><font color="#F00000">  <strong>Invalid username or password. Please try again.</strong></font></span>                               
                                                            <%                                
                                                            }                                
                                                            %>
                                                        </td>   
